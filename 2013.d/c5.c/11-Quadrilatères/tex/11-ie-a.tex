...
\begin{multicols}{2}
  ...
  \item 
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\linewidth]{sources/ie/qu-1.pdf}
    \end{figure}
  \item
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\linewidth]{sources/ie/qu-2.pdf}
    \end{figure}
  \item 
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\linewidth]{sources/ie/qu-3.pdf}
    \end{figure}
  \item  
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\linewidth]{sources/ie/qu-4.pdf}
    \end{figure}
  \end{enumerate}
\end{multicols}
\end{document}

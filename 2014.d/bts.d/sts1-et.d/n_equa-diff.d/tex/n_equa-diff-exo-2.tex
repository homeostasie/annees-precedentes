...
\begin{multicols}{2}
  ...
  \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.3\textwidth]{sources/ie/exo2-1.png}}
    \caption{$g'$}
  \end{figure}
\end{multicols}
  ...
  \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.65\textwidth]{sources/ie/exo2-2.png}}
...
\begin{multicols}{2}
  ...
  \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.4\textwidth]{sources/ie/exo3.png}}
  \end{figure}
